        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <form onSubmit={handleLogin} className="glass rounded-3xl p-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="glass-light border border-white/10 rounded-xl py-3 flex items-center justify-center gap-2 hover:bg-white/10 transition-all"
              >
                <Fingerprint className="w-5 h-5 text-[#FF6B00]" />
                <span className="text-white/90 font-medium">Face ID</span>
              </button>
              <button
                type="button"
                className="glass-light border border-white/10 rounded-xl py-3 flex items-center justify-center gap-2 hover:bg-white/10 transition-all"
