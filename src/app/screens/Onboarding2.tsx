        ...
        <div className="max-w-md w-full space-y-8">
          <div className="glass rounded-3xl p-12 flex flex-col items-center text-center space-y-6">
            <div className="bg-gradient-to-br from-[#FF6B00] to-[#FF8F3D] p-6 rounded-2xl">
              <Hammer className="w-16 h-16 text-white" strokeWidth={2} />
            </div>

            <div className="space-y-3">
              <h2 className="text-3xl font-bold text-white">Material & Labor Planning</h2>
              <p className="text-white/70 text-lg leading-relaxed">
                Calculate precise material quantities and labor costs. Track every resource from foundation to finishing.
              </p>
            </div>
          </div>
